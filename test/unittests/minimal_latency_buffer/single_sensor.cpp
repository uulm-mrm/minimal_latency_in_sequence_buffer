...
class MinimalLatencyBufferSingleSource : public ::testing::TestWithParam<std::string>
{
public:
  void SetUp() override
  {
...
TEST_P(MinimalLatencyBufferSingleSource, InSequenceMeasurements)
{
...
INSTANTIATE_TEST_SUITE_P(MinimalLatencyBufferSingleSource,
                         MinimalLatencyBufferSingleSource,
